...
<body>
    ...
    <nav>
        ...
        <div class="gruppobottoni">
            ...
            <a class="cre2Button creButton" href="pokemitology (2).html">Creazione</a>
            <a class="mainButton primeButton" href="pokemitology (3).html">Medioevo</a>
            <a class="mainButton primeButton" href="pokemitology (4).html">Presente</a>
        </div>
        <!-- Titolo e gif -->
        <div class="gruppotitolazzo">
            <img class="giffona1" src="/media/mew gif 2.gif" alt="gif di mewche balla">
            <a class="titolone" href="https://www.pokemon.com/it">
                
                <h1 class="title"> PokéMitology </h1>
                
            </a>
            <img class="giffona2" src="/media/Dittoballa.gif" alt="gif di Ditto che balla">
        </div>
        <!-- Barra di ricerca e gif -->
        <div class="sezionericerca">
            <form class="barraricerca">
                <input type="search" placeholder="Acchiappali Tutti!">
                <button type="submit"><img id="diglettGif" src="/media/diglett gif.gif" alt="diglett che sbuca e dice ok"></button>
            </form>
        </div>
        <!-- Cards -->
        <div class="container1">
            ...
            <a class="righette1" href="https://www.pokemonmillennium.net/rubriche/252203-arceus-e-la-creazione-del-mondo-pokemon/">
                <div class="cardhome1">
                    <img src="/media/gif arceus.gif" alt="gif di arceus" class="gifarceus">
            ...
            <a class="righette2" href="https://www.primevideo.com/-/it/detail/0TIOSBYKOWFF9SSXKEBHQZFIRI">
                <div class="cardhome2">
                    <img src="/media/mew gif.gif" alt="gif di mew" class="gifarceus">
                    <h2 class="titolazzo1">Quali sono le fonti?</h2>
                    <p class="testo1">Tutto quello che viene raccolto su questo sito, Ã¨ tratto dai <strong>Giochi Principali</strong>, dal famoso <strong>Teraleak</strong> e da interviste fatte ai producer di <strong>Gamefreak</strong>, come <strong>Junichi Masuda</strong>, <strong>Shigeki Morimoto</strong> e <strong>Ken Sugimori</strong>.
                    </p>
                </div>
            </a>
            ...
            <a class="righette3" href="https://www.youtube.com/watch?v=2JsjM0F1fqI">
                <div class="cardhome3">
                    <img src="/media/hooh gif.gif" alt="gif di ho oh" class="gifarceus">
                    <h2 class="titolazzo2">E la Serie invece?</h2>
                    <p class="testo1">La serie televisiva, i Film e i videogiochi prodotti da case sviluppatrici come <strong>ILCA</strong>, non verranno trattati. In quanto, <strong>NON SEGUONO IL CANON</strong> dei giochi principali, perchÃ© non c'Ã¨ <strong>Shigeru Ohmori</strong> dietro la scrittura.
                    </p>
                </div>
            </a>
            ...
            <a class="righette4" href="https://buymeacoffee.com/idane">
                <div class="cardhome4">
                    <img src="/media/meowth gif.gif" alt="gif di meowth che piange" class="gifarceus">

    ...
    <section class="mini-terminal" aria-label="Terminale">
      ...
      <div class="terminal-body">Il primo passo.</div>
        <div>-Riguardare la lezione, per ricordare meglio i comandi.</div>
          <div>-Riguardare la parte finale della lezione dove spiego come consegnare gli esercizi (questo ci servirÃ  da domani)
...
<div>-Creare una cartella allâ€™interno di wa e chiamarla â€œtest-comandiâ€</div>
<div>entrare nella cartella appena creata </div>
<div>-Nella cartella "test comandi" creare un file chiamato â€œciao.txtâ€</div>
...
<div>â€œmusicaâ€</div>
<div>â€œimmaginiâ€</div>
<div>â€œtestiâ€</div>
<div>e spostare il file â€œciao.txtâ€ nella cartella â€œtestiâ€</div>
<div>-Rimanendo nella cartella corrente "test comandi", creare un nuovo file, chiamato â€œbrani.txtâ€ </div>
<div>-Copiare il file â€œbrani.txtâ€ nella cartella â€œmusicaâ€, rimanendo nella cartella corrente </div>
...
<div>-Rimanendo nella cartella â€œmusicaâ€, eliminare il file â€œbrani.txtâ€ presente nella cartella padre â€œtest-comandiâ€. </div>
<div>-Tornare indietro, nella cartella â€œtest-comandiâ€ </div>
<div>-Nella cartella "test comandi", creare una nuova cartella di nome â€œlogsâ€ </div>
<div>-Entrare nella cartella "logs"</div>
<div>- creare 2 cartelle â€œbrowserâ€ e â€œserverâ€. </div>
<div>-Nella cartella "logs", creare un file chiamato â€œlogs.txtâ€</div>
...
<div>-Infine, eliminare la cartella â€œlogsâ€ con tutto il suo contenuto (attenzione che Ã© una cartella piena)</div>
      <div></div>
    </section>
  </main>
</body>

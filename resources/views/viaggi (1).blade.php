...
<head>
    ...
    <title>Gaza</title>
    <link rel="shortcut icon" href="/media/Icona Gaza.jpg" type="image/x-icon">
        <style>
        body {
            margin: 0;
            padding-top: 54px;
...
<body>
     ...
     <ul>
      ...
      <li><a href="viaggi (5).html">Contatti</a></li>
    </ul>
    </nav>
    <!-- Fine Navbar -->
    <!-- Inizio Header -->
    ...
    <!-- Inizio Main -->
     <main>
        ...
        <ol>Varie tappe di Gaza che vi porteremo a esplorare:
            ...
            <li>Strade Distrutte;</li>
            <li>Il mercato locale;</li>
            <li>Approfondimento sulla situazione del territorio;</li>
            <li>Case Distrutte 2.</li>
        </ol>
